...
def init_notebook(frame : tk.Frame) -> ttk.Notebook:
    ...
    # Populates the relation frame with the appropriate buttons from 'gui_buttons'.
    ...
    # Populates the class frame with the appropriate buttons from 'gui_buttons'.
    ...
    # Populates the method frame with the appropriate buttons from 'gui_buttons'.
    ...
    # Populates the field frame with the appropriate buttons from 'gui_buttons'.
    ...
    # Populates the param frame with the appropriate buttons from 'gui_buttons'.
