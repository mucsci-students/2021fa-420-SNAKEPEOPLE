...
class ImageAdapter():
    ...
    # Populate the canvas, save a snapshot of it, then delete the window.
...
###################################################################################################
'''
Main function that performs the Export command.
'''
def save_as_png(file_path):
        ...
        for i in UMLBox.class_list:
            ...
            for k in i.rels:
                if k[0] == "source":
                    ...
                    # Add a filled diamond for the relationship type 'Composition'.
                    ...
                    # Add a hollow triangle for the relationship type 'Inheritance'.
                    ...
                    # Add a hollow triangle for the relationship type 'Realization'.
                    else:
                        color = 'black'
                        add_dash = True
                        if x2 > x1:
    ...
    # Error message if the current UML cannot be exported.
    except:
