...
UMLbox.create_box(canvas, "class1asdasdadasdasdasdasda")
UMLbox.create_box(canvas, "class2asdasdadasdasdasdasda")
UMLline.add_line(canvas, "class1asdasdadasdasdasdasda", "class2asdasdadasdasdasdasda", "composition")
